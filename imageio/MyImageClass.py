...
class MyImgClass():
    ...
    def __sub__(self, other):
        ...
        """
        ### TO IMPLEMENT ###
        res = MyImgClass(np.abs(self.arrImg - other.arrImg), intLabel=None)
    ...
    def fPixelwiseSqDif(self, other):
        ...
        # raise NotImplementedError('You need to implement this method!')
        return MyImgClass(np.square((self-other).arrImg), intLabel=None)
    ...
    def fComputeMeanAcrossImages(lMyImgClass):
        ...
        ### TO IMPLEMENT ###
        # raise NotImplementedError('You need to implement this method!')
        l_stack = [item.arrImg for item in lMyImgClass]
        return MyImgClass(np.mean(l_stack, axis=0), intLabel=None)
    ...
    def fComputeStdAcrossImages(lMyImgClass):
        ...
        # raise NotImplementedError('You need to implement this method!')
        l_stack = [item.arrImg for item in lMyImgClass]
        return MyImgClass(np.std(l_stack, axis=0), intLabel=None)
